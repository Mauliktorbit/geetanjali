...
<div class="page-header">
    <div>
        ...
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Warehouses','url'=>route('admin.warehouses.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.warehouses.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
