...
@section('title', 'Add GiftCard')
@section('content')
<div class="page-header">
    <div>
        <h1>Add GiftCard</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'GiftCards','url'=>route('admin.gift-cards.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.gift-cards.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
