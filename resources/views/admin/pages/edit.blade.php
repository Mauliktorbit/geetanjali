...
<div class="page-header">
    <div>
        <h1>Edit Page</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Pages','url'=>route('admin.pages.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.pages.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
