...
<div class="page-header">
    <div>
        <h1>Edit Menu</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Menus','url'=>route('admin.menus.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.menus.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
