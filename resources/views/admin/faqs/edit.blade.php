...
<div class="page-header">
    <div>
        <h1>Edit Faq</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Faqs','url'=>route('admin.faqs.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.faqs.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
