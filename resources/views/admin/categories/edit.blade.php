...
<div class="page-header">
    <div>
        <h1>Edit Category</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Categorys','url'=>route('admin.categories.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.categories.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
