...
@section('title', 'Add HomepageSection')
@section('content')
<div class="page-header">
    <div>
        <h1>Add HomepageSection</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'HomepageSections','url'=>route('admin.homepage-sections.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.homepage-sections.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
