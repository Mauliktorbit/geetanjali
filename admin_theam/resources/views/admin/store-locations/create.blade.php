...
@section('title', 'Add StoreLocation')
@section('content')
<div class="page-header">
    <div>
        <h1>Add StoreLocation</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'StoreLocations','url'=>route('admin.store-locations.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.store-locations.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
