...
<form method="POST" action="{{ route('admin.login.submit') }}" class="guest-form" data-loading>
    ...
    <div class="form-group">
        ...
        <input id="email" type="email" name="email" class="form-control" value="{{ old('email', 'admin@ecommerce.test') }}" required autofocus autocomplete="username" placeholder="you@store.com">
