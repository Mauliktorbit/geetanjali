...
<div class="page-header">
    <div>
        <h1>Add FlashSale</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'FlashSales','url'=>route('admin.flash-sales.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.flash-sales.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
