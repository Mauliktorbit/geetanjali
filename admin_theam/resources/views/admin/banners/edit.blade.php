...
<div class="page-header">
    <div>
        <h1>Edit Banner</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Banners','url'=>route('admin.banners.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.banners.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
