...
<div class="page-header">
    <div>
        <h1>Edit Campaign</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Campaigns','url'=>route('admin.campaigns.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.campaigns.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
