...
@section('title', 'Add ShippingClass')
@section('content')
<div class="page-header">
    <div>
        <h1>Add ShippingClass</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'ShippingClasss','url'=>route('admin.shipping-classes.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.shipping-classes.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
