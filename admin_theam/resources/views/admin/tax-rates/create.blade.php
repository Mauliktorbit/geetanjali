...
@section('title', 'Add TaxRate')
@section('content')
<div class="page-header">
    <div>
        <h1>Add TaxRate</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'TaxRates','url'=>route('admin.tax-rates.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.tax-rates.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
