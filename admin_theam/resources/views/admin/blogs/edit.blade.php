...
<div class="page-header">
    <div>
        <h1>Edit Blog</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Blogs','url'=>route('admin.blogs.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.blogs.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
