...
<div class="page-header">
    <div>
        <h1>Add Brand</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Brands','url'=>route('admin.brands.index')], ['label'=>'Create']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data" class="form-grid">
        @csrf
