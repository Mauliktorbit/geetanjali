...
<div class="page-header">
    <div>
        <h1>Edit Brand</h1>
        @include('admin.components.breadcrumbs', ['items' => [['label'=>'Brands','url'=>route('admin.brands.index')], ['label'=>'Edit']]])
    </div>
</div>
@include('admin.components.alerts')
<div class="card">
    <form method="POST" action="{{ route('admin.brands.update', $item) }}" enctype="multipart/form-data" class="form-grid">
        @csrf
        @method('PUT')
            ...
            <div class="form-group">
                ...
                @if(!empty($item?->logo))
                    <div class="mt-2"><img src="{{ asset('storage/' . $item->logo) }}" alt="" class="thumb-sm"></div>
                @endif
            </div>
            <div class="form-group">
