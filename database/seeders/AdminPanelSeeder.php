...
class AdminPanelSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ['general.store_name', 'Geetanjali Jewellers'],
            ['general.currency', 'INR'],
            ['general.timezone', 'Asia/Kolkata'],
            ['general.date_format', 'd M Y'],
            ['general.language', 'en'],
            ['general.contact_email', 'maulik@torbitmultisoft.com'],
            ['general.contact_phone', '+91 9583959503'],
            ['general.business_address', 'C - 1209/1210, PNTC Tower, Times of India Press Road, Vejalpur, Ahmedabad - 380015'],
